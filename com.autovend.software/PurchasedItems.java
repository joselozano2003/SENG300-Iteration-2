...
public class PurchasedItems{
    ...
    private static ArrayList<Product> weightProducts;
    ...
    public static void addBarcodedProduct(BarcodedProduct product){
    ...
    public static void removeBarcodedProduct(BarcodedProduct product){
        listOfProducts.remove(product);
        totalPrice = totalPrice.subtract(product.getPrice());
        totalExpectedWeight -= product.getExpectedWeight();
    }
    // need for iteration 3
    public static void addPLUProduct(PLUCodedProduct product, double weight)
    {

    }
    // need for iteration 3
    public static void removePLUProduct(PLUCodedProduct product, double weight)
    {
    ...
    public static void removeProduct(Product product, double weight)
    {
        if(product.getPrice() > 0)
        {
            listOfProducts.remove(product);
